...
\renewcommand*{\maketitle}{
	\begin{titlepage}
		...
		\begin{center}
			...
			\vskip 0.5cm
			{\large \bfseries Projektierung \@researchPart\par}
			\vskip 0.5cm
			{\large an der}
			\vskip 0.5cm
			{\large Hochschule für Technik und Wirtschaft Berlin\\ Fachbereich  II\\ Studiengang Elektrotechnik}
			\vfill
			\begin{flushleft}
				\begin{tabular}[t]{rl}
					Betreuer: &\@firstExaminer\\
					\\
					Eingereicht von: & Sascha Schiebler 569314 \\
