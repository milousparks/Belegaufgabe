...
\def\thesistitle   {CACHET Technical Report Template}
\def\thesissubtitle{A nice standard XeLaTeX template for technical reports written and published by the Copenhagen Center for Health Technology.}
\def\thesislocation{\copyright~Copenhagen Center for \\ Health Technology,}
