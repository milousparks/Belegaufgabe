...
%%Graduation
\include{titles/research_paper}
%\gradeType{Angewandte Mathematik}
%\secondExaminer{Max Mustermann}

%Research paper
\include{titles/research_papger}
\subTitle{Filterkreis Projektierung\\TCR Projektierung \\ Leistungsschalter Projektierung}
\researchPart{einer dynamischen Blindstromkompensationsanlage}

%Angaben zur Arbeit und dem Author (von beiden Layouts genutzt)
\title{Thyristorgesteuerte Drossel (TCR) }
...
%\input{chapter/kozeptvergleich} \clearpage
%\input{chapter/drehstromtrafo} \clearpage
%\input{chapter/stromrichtertrafo} \clearpage
%\input{chapter/trafo_allgemeine_anforderungen} \clearpage
%\input{chapter/umrichter} \clearpage
%\input{chapter/berechnungen} \clearpage
